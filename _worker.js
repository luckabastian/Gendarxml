    ...
    for (let i = 0; i < this.proxies.length; i++) {
      ...
      <div class="proxy-card bg-white/10 backdrop-blur-sm dark:bg-neutral-800/70 
        ...
        for (let x = 0; x < proxyData.list.length; x += 2) {
          const protocols = [
            { name: `${reverse("NAJORT")} TLS`, icon: 'ð' },
            { name: `${reverse("SSELV")} TLS`, icon: 'ð' },
            { name: `${reverse("SS")} TLS`, icon: 'ð' },
            { name: `${reverse("NAJORT")} NTLS`, icon: 'ð' },
            { name: `${reverse("SSELV")} NTLS`, icon: 'ð' },
            { name: `${reverse("SS")} NTLS`, icon: 'ð' }
          ];
